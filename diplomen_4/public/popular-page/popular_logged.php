    ...
    <div class="container">
      ...
      <div class="recipes_lols">
        <?php foreach ($recipes as $recipe) { 
          ...
          $imagePath = isset($imagePaths[$recipe['Name']]) ? $imagePaths[$recipe['Name']] : "/diplomen_4/public/photos/default.jpg";
        ?>
          <div class="recipe-box">
            <a href="/diplomen_4/public/template/recipe_page.php?id=<?php echo $recipe['ID']; ?>">
