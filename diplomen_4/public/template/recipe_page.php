...
// Capture errors in an array
$debug_logs = [];

// Log session data before requiring config.php
$debug_logs[] = "Session data at start of recipe_page.php: " . json_encode($_SESSION);

require_once '/diplomen_4/config.php';

// Log session data after requiring config.php
$debug_logs[] = "Session data after config.php: " . json_encode($_SESSION);
...
// Check if user is logged in and store their user ID
$usersID = isset($_SESSION['users_id']) ? $_SESSION['users_id'] : null;
...
if (!$recipe) {
    die("Recipe not found!");
                ...
                //if (!isset($_SESSION['users_id'])) {
                 //      error_log('User is not logged in, redirecting...');
...
$recipe_images = [
    ...
    'Margarita Pizza' => '/diplomen_4/public/photos/5e24db6215db855d7e036741cb5c115d.jpg',
    'Caesar Salad' => '/diplomen_4/public/photos/5e24db6215db855d7e036741cb5c115d.jpg',
];
$image_url = isset($recipe_images[$recipe['Name']]) ? $recipe_images[$recipe['Name']] : '/diplomen_4/public/photos/default_recipe.jpg';
?>
